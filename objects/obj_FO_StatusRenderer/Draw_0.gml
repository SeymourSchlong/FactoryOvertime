...
if (global.fo.scoremult.gloober > 1) {
    draw_sprite(agi("spr_FO_Status_Gloober"), other.image_index, _draw_x + 25, _draw_y + 25 + _current_y);
    draw_text(_draw_x + 50, _draw_y + 25 + _current_y, "x" + string(global.fo.scoremult.gloober));
    _current_y += 50;
}
    
if (global.fo.scoremult.boxofnails > 1) {
    draw_sprite(agi("spr_FO_Status_BoxOfNails"), other.image_index, _draw_x + 25, _draw_y + 25 + _current_y);
    draw_text(_draw_x + 50, _draw_y + 25 + _current_y, "x" + string(global.fo.scoremult.boxofnails));
    _current_y += 50;
}
    
if (global.fo.scoremult.heartmonitor > 1) {
    draw_sprite(agi("spr_FO_Status_HeartMonitor"), other.image_index, _draw_x + 25, _draw_y + 25 + _current_y);
    draw_text(_draw_x + 50, _draw_y + 25 + _current_y, "x" + string(global.fo.scoremult.heartmonitor));
    _current_y += 50;
}
    
if (global.fo.scoremult.piyopiyos > 1) {
    draw_sprite(agi("spr_FO_Status_PiyoPiyos"), other.image_index, _draw_x + 25, _draw_y + 25 + _current_y);
